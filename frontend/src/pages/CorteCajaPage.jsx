...
import { getCortesCaja, getCorteCaja, createCorteCaja, closeCorteCaja } from '../services/endpoints'
        ...
        <form onSubmit={handleClose} className="space-y-4">
          {closingCorte && (
            <div className="rounded-lg bg-amber-50 border border-amber-200 p-3 text-sm text-amber-800">
              ...
              <p className="text-xs mt-2 text-amber-700">El resumen de ventas se calculará automáticamente al cerrar.</p>
            </div>
          )}
          <div>
